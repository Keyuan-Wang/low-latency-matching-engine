...
void test_run_scenario_latency() {
  class SmokeScenario : public benchmark_runner::IBenchScenario {
   public:
    ...
    bool PrepareAndRun(const benchmark_runner::Args&, std::uint64_t,
  ...
  char arg1[] = "--metric"; char arg2[] = "latency";
  char arg3[] = "--iters"; char arg4[] = "10";
  char arg5[] = "--warmup-iters"; char arg6[] = "2";
  char arg7[] = "--batch-size"; char arg8[] = "1";
  char arg9[] = "--trial-id"; char arg10[] = "99";
  char arg11[] = "--version-tag"; char arg12[] = "test";
  char arg13[] = "--out"; char arg14[] = "/tmp/bench_smoke_test_run.csv";
  char* argv[] = {arg0, arg1, arg2, arg3, arg4, arg5, arg6, arg7,
                  arg8, arg9, arg10, arg11, arg12, arg13, arg14};
  int argc = sizeof(argv) / sizeof(argv[0]);

  int rc = benchmark_runner::RunScenario(SmokeScenario{}, argc, argv);
  ...
  check(data.find("latency,smoke,test") != std::string::npos, "data row contains expected fields");
  ...
  rc = benchmark_runner::RunScenario(SmokeScenario{}, argc2, argv2);
