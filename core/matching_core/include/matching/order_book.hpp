/**
 * @file order_book.hpp
 * @brief Central limit order book — gateway-owned validation contract.
 *
 * The matching core assumes all incoming order ids are valid. The exchange
 * gateway is responsible for duplicate-id and cancel-before-insert checks.
 */
 ...
 *
 * @note Duplicate-id and cancel-before-insert validation has been removed.
 *       The matching core assumes all inputs are valid.
 */
class OrderBook {
public:
